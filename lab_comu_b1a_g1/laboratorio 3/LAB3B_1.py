...
from LAB3_parteB import LAB3_parteB  # grc-generated hier_block
...
class LAB3B_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB3B_1")
        ...
        self._fm2_range = Range(0, 10000, 100, 100, 200)
        self._fm2_win = RangeWidget(self._fm2_range, self.set_fm2, "frec m2", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._fm2_win)
        self._fm1_range = Range(0, 10000, 10, 1000, 200)
        self._fm1_win = RangeWidget(self._fm1_range, self.set_fm1, "frec m1", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.analog_sig_source_x_0_0 = analog.sig_source_f(samp_rate, analog.GR_TRI_WAVE, fm2, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm1, 1, 0, 0)
        self.LAB3_parteB_0 = LAB3_parteB(
            Ac=Ac,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.LAB3_parteB_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.LAB3_parteB_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.LAB3_parteB_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.LAB3_parteB_0, 0))
        self.connect((self.analog_sig_source_x_0_0, 0), (self.LAB3_parteB_0, 1))
    ...
    def set_fm2(self, fm2):
        self.fm2 = fm2
        self.analog_sig_source_x_0_0.set_frequency(self.fm2)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.LAB3_parteB_0.set_Ac(self.Ac)




def main(top_block_cls=LAB3B_1, options=None):
