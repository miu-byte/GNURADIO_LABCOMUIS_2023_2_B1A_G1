...
class LAB2_parteB(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB2_parteB")
...
def main(top_block_cls=LAB2_parteB, options=None):
